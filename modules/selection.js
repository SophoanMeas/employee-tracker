  ...
  printTable(rows){
      ...
      const p = new Table({
          ...
          columns:[
              ...
              { name: 'first_name', title: 'First Name', alignment: 'left', color: 'green'},
              { name: 'last_name', title: 'Last Name', alignment: 'left', color: 'green'},
              { name: 'title', title: 'Title', alignment: 'center', color: 'yellow'},
              { name: 'department', title: 'Department', alignment: 'center', color: 'orange'},
              { name: 'salary', title: 'Salary', alignment: 'left'},
              { name: 'manager', title: 'Manager', alignment: 'center', color:'cyan'},
          ]
      });


      for (let i = 0; i < rows.length; i++){
        p.addRow({id: rows[i].id, 
